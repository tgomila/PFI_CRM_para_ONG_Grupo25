package com.pfi.crm.mastertenant.config;
...
@EnableJpaRepositories(basePackages = {"com.pfi.crm.multitenant.mastertenant.entity", "com.pfi.crm.multitenant.mastertenant.repository"},
