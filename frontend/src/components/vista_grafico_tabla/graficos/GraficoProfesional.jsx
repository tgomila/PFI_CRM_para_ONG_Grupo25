...
const GraficoProfesional = ({visibilidadInput}) => {
  
  //Que cambiar si copias y pegas este código:
  const Service = ProfesionalService;//Tambien cambiar el "Service" importado
  const el_la = "el";
  const nombreDatoSingular = "profesional";
  const las_los = "los";
  const nombreDatoPlural = "profesionales";
  ...
  const dataExampleEdad = [
    ...
    { rangoEdad: "19 a 26 años", etapa: "Juventud", cantidad: 1 },
