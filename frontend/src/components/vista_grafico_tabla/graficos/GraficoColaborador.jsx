...
const GraficoColaborador = ({visibilidadInput}) => {
  
  //Que cambiar si copias y pegas este código:
  const Service = ColaboradorService;//Tambien cambiar el "Service" importado
  const el_la = "el";
  const nombreDatoSingular = "colaborador";
  const las_los = "los";
  const nombreDatoPlural = "colaboradores";
