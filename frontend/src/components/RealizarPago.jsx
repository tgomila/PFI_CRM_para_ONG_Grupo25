...
import "../Styles/RealizarPago.scss";
import RealizarPagoService from '../services/RealizarPagoService';


function RealizarPago(moduloAPagar) {
	...
	const handleSubmitPago = (e) => {
		...
		RealizarPagoService.postPago( moduloAPagar).then
			(response => {
				setLoading(false);
	...
	return (
		<div class="RealizarPago">
			...
			<main id="main" class="mx-auto">
				...
				<section id="right">
					<h1>Purchase {moduloAPagar.moduloAPagar}</h1>
					<form action="#">
						<div id="form-card" class="form-field">
							<label for="cc-number">Card number:</label>
							<input id="cc-number" maxlength="19" placeholder="1111 2222 3333 4444" required></input>
						</div>
						...
						<div id="form-sec-code" class="form-field">
							...
							<input type="password" maxlength="3" placeholder="123" required></input>
						</div>

						<button type="submit" onClick={handleSubmitPago} disabled={loading}>Purchase Premium
							<span></span>
							<span></span>
							<span></span>
							<span></span>
