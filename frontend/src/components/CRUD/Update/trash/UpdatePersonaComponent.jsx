...
function UpdatePersonaComponent() {
    ...
    const [submittedMessage, setSubmittedMessage] = useState("¡Has modificado la persona!");
        ...
        if (checkBtn.current.context._errors.length === 0) {
            PersonaService.update(data).then
                (response => {
                    ...
                    setSubmittedMessage("¡Has modificado la persona!");
                    if(fotoSubida && persona.id){
                        ...
                        ImageService.uploadImageContacto(persona.id, fotoSubida).then
                            (response => {
                                ...
                                setSubmittedMessage("¡Has modificado la persona y su foto!");
                                console.log("Se subió la foto :D");
                                console.log(response);
                            },
                            (error) => {
                                setSubmittedFoto(false);
                                setSubmittedMessage("¡Has modificado la persona! Pero su foto por error no ha sido modificado");
                                setLoading(false);
                                console.log("error:");
                                console.log(error);
                            }
                ...
                (error) => {
                    ...
                    setSubmittedFoto(false);
                    setSubmittedMessage("Error al modificar a la persona");
                    setLoading(false);
