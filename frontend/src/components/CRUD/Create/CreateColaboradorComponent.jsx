...
function CreateColaboradorComponent() {
    ...
    const [colaborador, setColaborador] = useState(cargarColaboradorDefault);
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        setColaborador(cargarColaboradorDefault);
        setMessageSearch("");
        ...
        if (checkBtnSearch.current.context._errors.length === 0) {
            ColaboradorService.search(idToSearch).then
                (response => {
                    if(response.data.id)
                    ...
                    //    //...sigue
                    //});
                    setColaborador(prevPerson => ({ ...prevPerson, ...response.data }));
    ...
    const handleSubmit = (e) => {
       ...
       let data = {...colaborador}; //Copio datos a "data" para el json de alta
        if (checkBtn.current.context._errors.length === 0) {
            ColaboradorService.create(data).then
                (response => {
                    setColaborador(prevPerson => ({ ...prevPerson, ...response.data }));
                setSubmitted(true);
                ...
                <div className = "container">
                    <div className = "row">
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                          {submitted ? (
                            <div>
                                <h4>¡Has cargado el colaborador!</h4>
                                <button className="btn btn-success" onClick={newColaborador}>
                            ...
                            <div className = "card-body">
                                ...
                                {(contactoSearchEncontrado && !mostrarSearchID) && (
                                    <div className = "form-group">
                                        ...
                                        <button className="btn btn-light" onClick={newColaborador} style={{marginLeft: "00px"}}>
                                            Cancelar Búsqueda
                                        </button>
                                        </div>
                                        <div>
                                ...
                                <Form onSubmit={handleSubmit} ref={form}>
                                    {contactoSearchEncontrado && (
                                        <div className = "form-group">
                                            ...
                                            value={colaborador.id} onChange={handleInputChange}/>
                                        </div>
                                    )}
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={personaSearchEncontrada} placeholder="Nombre" id="nombre" name="nombre" type="text" className="form-control" 
                                            value={colaborador.nombre} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={personaSearchEncontrada} placeholder="Apellido" id="apellido" name="apellido" type="text" className="form-control" 
                                            value={colaborador.apellido} onChange={handleInputChange} validations={[required]}/>
                                    </div>
        
                                    <div className = "form-group">
                                        <label> DNI: </label>
                                        <Input disabled={personaSearchEncontrada} placeholder="Dni" id="dni" name="dni" type="number" className="form-control" 
                                            value={colaborador.dni} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={personaSearchEncontrada} placeholder="dd-mm-yyyy" id="fechaNacimiento" name="fechaNacimiento" type="date" className="form-control" 
                                            value={colaborador.fechaNacimiento} onChange={handleInputChange} validations={[required]}
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Cuit" id="cuit" name="cuit" type="text" className="form-control" 
                                            value={colaborador.cuit} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Domicilio" id="domicilio" name="domicilio" type="text" className="form-control" 
                                            value={colaborador.domicilio} onChange={handleInputChange} validations={[required]}/>
                                    </div>
        
                                    <div className = "form-group">
                                        <label> Email: </label>
                                        <Input disabled={contactoSearchEncontrado} placeholder="Email" id="email" name="email" type="text" className="form-control" 
                                            value={colaborador.email} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Telefono" id="telefono" name="telefono" type="text" className="form-control" 
                                            value={colaborador.telefono} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Descripción" name="nombreDescripcion" type="text" className="form-control" 
                                            value={colaborador.nombreDescripcion} onChange={handleInputChange} validations={[required]}/>
                                    </div>

                                    <div className = "form-group">
                                        <label> Datos bancarios: </label>
                                        <Input placeholder="Datos bancarios" name="datosBancarios" type="text" className="form-control" 
                                            value={colaborador.datosBancarios} onChange={handleInputChange} validations={[required]}/>
                                    </div>

                                    <div className = "form-group">
                                        <label> Área: </label>
                                        <Input placeholder="Area" name="area" type="text" className="form-control" 
                                            value={colaborador.area} onChange={handleInputChange} validations={[required]}/>
                                    </div>
