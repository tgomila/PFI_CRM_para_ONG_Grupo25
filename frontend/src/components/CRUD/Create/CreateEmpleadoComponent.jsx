...
function CreateEmpleadoComponent() {
    ...
    const [empleado, setEmpleado] = useState(cargarEmpleadoDefault);
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        setEmpleado(cargarEmpleadoDefault);
        setMessageSearch("");
        ...
        if (checkBtnSearch.current.context._errors.length === 0) {
            EmpleadoService.search(idToSearch).then
                (response => {
                    if(response.data.id)
                    ...
                    //    //...sigue
                    //});
                    setEmpleado(prevPerson => ({ ...prevPerson, ...response.data }));
    ...
    const handleSubmit = (e) => {
       ...
       let data = {...empleado}; //Copio datos a "data" para el json de alta
        if (checkBtn.current.context._errors.length === 0) {
            EmpleadoService.create(data).then
                (response => {
                    setEmpleado(prevPerson => ({ ...prevPerson, ...response.data }));
                setSubmitted(true);
                ...
                <div className = "container">
                    <div className = "row">
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                          {submitted ? (
                            <div>
                                <h4>¡Has cargado el empleado!</h4>
                                <button className="btn btn-success" onClick={newEmpleado}>
                            ...
                            <div className = "card-body">
                                ...
                                {(contactoSearchEncontrado && !mostrarSearchID) && (
                                    <div className = "form-group">
                                        ...
                                        <button className="btn btn-light" onClick={newEmpleado} style={{marginLeft: "00px"}}>
                                            Cancelar Búsqueda
                                        </button>
                                        </div>
                                        <div>
                                ...
                                <Form onSubmit={handleSubmit} ref={form}>
                                    {contactoSearchEncontrado && (
                                        <div className = "form-group">
                                            ...
                                            value={empleado.id} onChange={handleInputChange}/>
                                        </div>
                                    )}
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={personaSearchEncontrada} placeholder="Nombre" id="nombre" name="nombre" type="text" className="form-control" 
                                            value={empleado.nombre} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={personaSearchEncontrada} placeholder="Apellido" id="apellido" name="apellido" type="text" className="form-control" 
                                            value={empleado.apellido} onChange={handleInputChange} validations={[required]}/>
                                    </div>
        
                                    <div className = "form-group">
                                        <label> DNI: </label>
                                        <Input disabled={personaSearchEncontrada} placeholder="Dni" id="dni" name="dni" type="number" className="form-control" 
                                            value={empleado.dni} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={personaSearchEncontrada} placeholder="dd-mm-yyyy" id="fechaNacimiento" name="fechaNacimiento" type="date" className="form-control" 
                                            value={empleado.fechaNacimiento} onChange={handleInputChange} validations={[required]}
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Cuit" id="cuit" name="cuit" type="text" className="form-control" 
                                            value={empleado.cuit} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Domicilio" id="domicilio" name="domicilio" type="text" className="form-control" 
                                            value={empleado.domicilio} onChange={handleInputChange} validations={[required]}/>
                                    </div>
        
                                    <div className = "form-group">
                                        <label> Email: </label>
                                        <Input disabled={contactoSearchEncontrado} placeholder="Email" id="email" name="email" type="text" className="form-control" 
                                            value={empleado.email} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Telefono" id="telefono" name="telefono" type="text" className="form-control" 
                                            value={empleado.telefono} onChange={handleInputChange} validations={[required]}/>
                                    </div>
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <Input disabled={contactoSearchEncontrado} placeholder="Descripción" name="nombreDescripcion" type="text" className="form-control" 
                                            value={empleado.nombreDescripcion} onChange={handleInputChange} validations={[required]}/>
                                    </div>

                                    <div className = "form-group">
                                        <label> Datos bancarios: </label>
                                        <Input placeholder="Datos bancarios" name="datosBancarios" type="text" className="form-control" 
                                            value={empleado.datosBancarios} onChange={handleInputChange} validations={[required]}/>
                                    </div>

                                    <div className = "form-group">
                                        <label> Función: </label>
                                        <Input placeholder="Función" name="funcion" type="text" className="form-control" 
                                            value={empleado.funcion} onChange={handleInputChange} validations={[required]}/>
                                    </div>

                                    <div className = "form-group">
                                        <label> Descripción de su función: </label>
                                        <Input placeholder="Descripción de su función" name="descripcion" type="text" className="form-control" 
                                            value={empleado.descripcion} onChange={handleInputChange} validations={[required]}/>
                                    </div>
