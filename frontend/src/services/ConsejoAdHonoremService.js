...
class ConsejoAdHonoremService {
    ...
    creadosUltimos12meses(){
        return axios.get(BACKEND_API_BASE_URL + 'consejoadhonorem/grafico/contar_creados/ultimos_12_meses', { headers: authHeader() });
    }
    
    categoriaEdades(){
        return axios.get(BACKEND_API_BASE_URL + 'consejoadhonorem/grafico/contar_categoria_edad', { headers: authHeader() });
    }
