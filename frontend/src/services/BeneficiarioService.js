...
class BeneficiarioService {
    ...
    creadosUltimos12meses(){
        return axios.get(BACKEND_API_BASE_URL + 'beneficiario/grafico/contar_creados/ultimos_12_meses', { headers: authHeader() });
    }
    
    categoriaEdades(){
        return axios.get(BACKEND_API_BASE_URL + 'beneficiario/grafico/contar_categoria_edad', { headers: authHeader() });
    }
